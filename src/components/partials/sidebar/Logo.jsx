    ...
    >
      <Link to="/dashboard">
        <div className="flex items-center space-x-4">
          <div className="logo-icon w-11/12">
            <img src={MobileLogo} alt="" />
          </div>

          {/* {(!collapsed || menuHover) && (
            <div>
              <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100"> Kent Water Purification Systems</h1>
            </div>
          )} */}
        </div>
      </Link>
      ...
      {(!collapsed || menuHover) && (
        <div
          ...
          className={`h-4 w-5 border-[1.5px] border-slate-900 dark:border-slate-700 rounded-full transition-all duration-150
          ${
            collapsed
              ? ""
