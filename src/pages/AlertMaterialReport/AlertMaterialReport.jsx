...
import { API_ALERT_MATERIAL_REPORT , API_DELETE_SPAREPARTS} from "@/services/ApiEndPoint";
...
export const AlertMaterialReport = () => {
    ...
    const getData = async () => {
        try {
            setLoading(true);
            const response = await Api.get(`${API_ALERT_MATERIAL_REPORT}?page=${pageIndex}&size=${size}`);  
            setLoading(false);
